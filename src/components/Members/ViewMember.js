...
class ViewMember extends Component {
  ...
  deleteMember() {
    ...
    Axios.delete(URL).then((response) => {
      ...
      this.setState({responseDataMessage: response.data.message})
      // alert(`${this.state.responseDataMessage}`);
          ...
          ? (
            <div>
              <Well>
                ...
                <p>
                  <a href={`mailto:${this.state.member.email}?Subject=Hello%20again`} target="_top">{this.state.member.email}</a>
                </p>
                ...
                {this.state.member.address.street
                  ...
                  : (
                    <p>
                      <i>There is no address saved for this member.</i>
                    </p>
                  )}
                ...
                {this.state.member.phone
                  ...
                  : (
                    <p>
                      <i>There is no phone number saved for this member.</i>
                    </p>
                  )}
                ...
                {this.state.member.birthday.day
                  ...
                  : (
                    <p>
                      <i>There is no birthday saved for this member.</i>
                    </p>
                  )}
                ...
                <Button bsStyle="info" onClick={this.openEditModal}>Edit User</Button>
                {` `}
                <Button bsStyle="danger" onClick={this.openDeleteConfirmModal}>Delete</Button>
              </Well>
                  ...
                  <Tabs defaultActiveKey={1} id="edit-user-modal">
                        ...
                        <Tab eventKey={1} title="General">
                          ...
                          <Form>
                            ...
                            <FormGroup controlId="formHorizontalFirst">
                              ...
                              <Col >
                                <FormControl type="text" defaultValue={this.state.member.name.first} placeholder="John" inputRef={ref => {
                            ...
                            <FormGroup controlId="formHorizontalLast">
                              ...
                              <Col >
                                <FormControl type="text" name="lastName" defaultValue={this.state.member.name.last} placeholder="Smith" onChange={this.handleInputChange} inputRef={ref => {
                            ...
                            <FormGroup controlId="formHorizontalEmail">
                              ...
                              <Col >
                                <FormControl type="email" defaultValue={this.state.member.email} placeholder="Email" inputRef={ref => {
                                  this.inputEmail = ref;
                                }}/>
                              </Col>
                            </FormGroup>
                            <FormGroup controlId="formHorizontalPhone">
                              ...
                              <Col >
                                <FormControl type="phone" defaultValue={this.state.member.phone} placeholder="Phone" inputRef={ref => {
                                  this.inputPhone = ref;
                                }}/>
                              </Col>
                            </FormGroup>
                        ...
                        ? (
                          ...
                          <Form>
                            ...
                            <FormGroup controlId="formHorizontalStreet">
                              ...
                              <Col >
                                <FormControl type="text" defaultValue={this.state.member.address.street} placeholder="123 Happy St" inputRef={ref => {
                            ...
                            <FormGroup controlId="formHorizontalCity">
                              ...
                              <Col >
                                <FormControl type="city" placeholder="Sydney" defaultValue={this.state.member.address.city} inputRef={ref => {
                            ...
                            <FormGroup controlId="formHorizontalState">
                              ...
                              <Col >
                                <FormControl type="state" placeholder="NSW" defaultValue={this.state.member.address.state} inputRef={ref => {
                    ...
                    <Tab eventKey={3} title="Settings">
                      <Form>
                        ...
                        <Checkbox defaultChecked={this.state.member.emailOptIn} inputRef={ref => {
              ...
              {/* this is the member delete confirmation modal  */}
              ...
              {/* this is the success action modal  */}
              <Modal bsSize="small" show={this.state.showSuccessModal} onHide={this.closeSuccessModal}>
                <Modal.Header closeButton>
